...
struct Payroll {
  ...
  static func calculateMonthlyNetSalary(salary: NSDecimalNumber) -> NSDecimalNumber {
    ...
    let netSalary: NSDecimalNumber = salaryAfterAFP_SFS.decimalNumberBySubtracting(salaryISRDeductionAmount)
  ...
  static func calculateBiWeeklyNetSalary(salary: NSDecimalNumber) -> NSDecimalNumber {
    ...
    return NSDecimalNumber.roundToNearestTwo(calculateSalary.decimalNumberByDividingBy(2))
