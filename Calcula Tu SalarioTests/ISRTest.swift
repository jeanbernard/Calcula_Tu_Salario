...
class ISRTest: XCTestCase {
  ...
  var firstScaleSalary = 0.0
  var secondScaleSalary = 0.0
  var thirdScaleSalary = 0.0
  ...
  func testNetSalaryDoesNotApplyForISR() {
    let lowSalary = 30000.00
    let salaryAppliesForISR = ISR.doesSalaryApplyForISR(lowSalary)
